...
class Buku {
    ...
    function create(){
        ...
        $this->Kategori_ID = (int) htmlspecialchars(strip_tags($this->Kategori_ID));
        $this->Penerbit_ID = (int) htmlspecialchars(strip_tags($this->Penerbit_ID));
        $this->Deskripsi = htmlspecialchars(strip_tags($this->Deskripsi));
        $this->Stok = (int) htmlspecialchars(strip_tags($this->Stok));
